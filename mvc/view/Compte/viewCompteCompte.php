                                        ...
                                        <div class="col-11">
                                            <div class="form-card">
                                                ...
                                                <form name="form" method="POST" action="index.php?controller=utilisateur&action=updated">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-6">
                                                            <div class="input-group"> <input type="text" name="prenom_utilisateur" id="prenom" > <label>Prénom</label> </div>
                                                        </div>
                                                        <div class="col-6">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-6">
                                                            <div class="input-group"> <input type="text" name="num_permis" id="num_permis" > <label>Numéro de permis</label> </div>
                                                        </div>
                                                        <div class="col-6">
